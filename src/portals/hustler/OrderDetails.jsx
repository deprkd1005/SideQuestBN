    ...
    <div className="app-content no-scrollbar" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div style={{ padding: '0 24px 100px' }}>
        ...
        <div className="card-glass" style={{ padding: '20px', display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
          ...
          <button className="btn-ghost" style={{ padding: '10px' }}><MessageSquare size={20} className="text-gold" /></button>
        </div>

        <div className="card" style={{ padding: '24px', marginBottom: '32px' }}>
          <div className="badge badge-gold" style={{ marginBottom: '12px' }}>{order.service.category}</div>
          <h2 style={{ fontSize: '1.3rem', fontWeight: 900, marginBottom: '8px' }}>{order.service.title}</h2>
          <div style={{ fontSize: '1.2rem', fontWeight: 900, color: 'var(--gold)', marginBottom: '20px' }}>BND {order.service.price}</div>
