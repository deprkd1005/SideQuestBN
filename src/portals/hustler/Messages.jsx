...
import { MessageSquare, Send, X, User, ChevronLeft, MoreVertical, Paperclip, Smile, Camera, Search } from 'lucide-react';
          ...
          >
            ...
            <div className="flex-between" style={{ padding: '24px 20px 12px' }}>
              <div>
                ...
                <p className="section-subtitle">Chat with your Quest partners</p>
              </div>
