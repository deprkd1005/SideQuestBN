      ...
      <div style={{ padding: '0 24px 100px', marginTop: '-40px', position: 'relative' }}>
        <div className="card" style={{ padding: '24px', marginBottom: '24px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
          <div className="flex-between" style={{ marginBottom: '12px' }}>
            <span className="badge badge-emerald" style={{ padding: '6px 12px' }}>{service.category}</span>
          ...
          <div style={{ fontSize: '1.2rem', fontWeight: 900, color: 'var(--emerald)', marginBottom: '16px' }}>BND {service.price}</div>
          
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--text-secondary)', fontSize: '0.8rem', fontWeight: 600 }}>
              <MapPin size={14} className="text-emerald" /> {service.provider.profile?.location || 'Brunei Muara'}
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--text-secondary)', fontSize: '0.8rem', fontWeight: 600 }}>
              <Shield size={14} className="text-emerald" /> Escrow Protected
            </div>
          </div>
        </div>
